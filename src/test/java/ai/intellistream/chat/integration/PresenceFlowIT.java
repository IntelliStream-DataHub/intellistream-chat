...
import ai.intellistream.chat.web.PresenceEventListener;
import ai.intellistream.chat.web.PresenceRestController;
...
class PresenceFlowIT {
    ...
    void connectedUserDefaultsToActiveKind() {
        ...
        assertThat(dto.kind()).isEqualTo(ai.intellistream.chat.domain.PresenceKind.ACTIVE);
    }
    ...
    void disconnectedUserWithoutOverrideIsOffline() {
        ...
        assertThat(dto.online()).isFalse();
        assertThat(dto.kind()).isEqualTo(ai.intellistream.chat.domain.PresenceKind.OFFLINE);
    }
    ...
    void manualAwayBeatsConnectedAutoState() {
        ...
        var dto = presenceService.setKind(alice, ai.intellistream.chat.domain.PresenceKind.AWAY);

        assertThat(dto.kind()).isEqualTo(ai.intellistream.chat.domain.PresenceKind.AWAY);
        assertThat(dto.online()).isFalse();
    }
    ...
    void manualDndAndOfflineAreAlsoApplied() {
        ...
        assertThat(presenceService.setKind(alice, ai.intellistream.chat.domain.PresenceKind.DND).kind())
                .isEqualTo(ai.intellistream.chat.domain.PresenceKind.DND);
        assertThat(presenceService.setKind(alice, ai.intellistream.chat.domain.PresenceKind.OFFLINE).kind())
                .isEqualTo(ai.intellistream.chat.domain.PresenceKind.OFFLINE);
    }
    ...
    void clearKindReturnsToActiveForConnectedUser() {
        var alice = newUser("alice");
        tracker.connect(alice.getUsername(), "session-solo");
        presenceService.setKind(alice, ai.intellistream.chat.domain.PresenceKind.AWAY);
    ...
    void settingActiveAlsoClearsOverride() {
        ...
        var dto = presenceService.setKind(alice, ai.intellistream.chat.domain.PresenceKind.ACTIVE);
    ...
    void manualOverrideBeatsAutoAway() {
        ...
        assertThat(dto.kind()).isEqualTo(ai.intellistream.chat.domain.PresenceKind.DND);
    }
    ...
    void batchPresenceLookupComputesAutoAway() {
        ...
        assertThat(byUsername.get(fresh.getUsername())).isEqualTo(ai.intellistream.chat.domain.PresenceKind.ACTIVE);
        assertThat(byUsername.get(idle.getUsername())).isEqualTo(ai.intellistream.chat.domain.PresenceKind.AWAY);
    }
    ...
    void clearStatusKeepsManualKind() {
        ...
        assertThat(afterClear.kind()).isEqualTo(ai.intellistream.chat.domain.PresenceKind.AWAY);
    ...
    void putKindEndpointBroadcasts() {
        ...
        var dto = controller.setKind(
                new ai.intellistream.chat.web.dto.SetPresenceKindRequest(
                        ai.intellistream.chat.domain.PresenceKind.AWAY),
                mock(Principal.class));
    ...
    void deleteKindEndpointClearsOverrideAndBroadcasts() {
        ...
        tracker.connect(alice.getUsername(), "session-solo");
        when(currentUser.resolve(any(Principal.class))).thenReturn(alice);
        controller.setKind(new ai.intellistream.chat.web.dto.SetPresenceKindRequest(
                ai.intellistream.chat.domain.PresenceKind.DND), mock(Principal.class));
