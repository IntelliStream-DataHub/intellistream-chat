...
@SpringBootApplication(
        scanBasePackages = {
                "ai.intellistream.threadorbit.service",
                "ai.intellistream.threadorbit.repository",
                "ai.intellistream.threadorbit.search",
                "ai.intellistream.threadorbit.slash"
        },
        exclude = {
...
@EntityScan("ai.intellistream.threadorbit.domain")
@EnableJpaRepositories("ai.intellistream.threadorbit.repository")
public class IntegrationTestApplication {

    /**
     * The web-layer auto-configs are excluded above (no STOMP / WebSocket beans), but
     * {@link ai.intellistream.threadorbit.slash.ReminderScheduler} and the presence event listener still
