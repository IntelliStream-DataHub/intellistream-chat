...
@SpringBootTest(
        ...
        properties = {
                "threadorbit.write-behind.enabled=true",
                "threadorbit.write-behind.flush-interval-ms=5",
                "threadorbit.write-behind.batch-size=64",
                "threadorbit.search.lucene-dir=build/test-lucene/WriteBehindFlowIT"
        }
)
class WriteBehindFlowIT {
    ...
    private List<ai.intellistream.threadorbit.domain.Message> storedOldestFirst(Channel room) {
        ...
        out.sort(Comparator.comparing(ai.intellistream.threadorbit.domain.Message::getId));
        return out;
    }
}
