...
@SpringBootApplication(
        scanBasePackages = {
                "ai.intellistream.radiance.service",
                "ai.intellistream.radiance.repository",
                "ai.intellistream.radiance.search",
                "ai.intellistream.radiance.slash"
        },
        exclude = {
...
@EnableJpaRepositories("ai.intellistream.radiance.repository")
public class IntegrationTestApplication {

    /**
     * The web-layer auto-configs are excluded above (no STOMP / WebSocket beans), but
     * {@link ai.intellistream.radiance.slash.ReminderScheduler} and the presence event listener still
