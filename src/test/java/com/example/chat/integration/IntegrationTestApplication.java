...
@SpringBootApplication(
        scanBasePackages = {
                ...
                "com.example.chat.search",
                "com.example.chat.slash"
        },
        exclude = {
...
@EntityScan("com.example.chat.domain")
...
public class IntegrationTestApplication {
     ...
     * {@link com.example.chat.slash.ReminderScheduler} and the presence event listener still
