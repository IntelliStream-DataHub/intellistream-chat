 ...
 *
 * <p>Posts a short host message containing the question, then attaches a {@link com.example.chat.domain.Poll}
 * row with the options. The frontend renders the host message with a click-to-vote widget
 * sourced from {@link com.example.chat.web.dto.PollDto} on the message DTO. Reactions on the
