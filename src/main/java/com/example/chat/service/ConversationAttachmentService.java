...
import com.example.chat.domain.ConversationAttachment;
import com.example.chat.domain.ConversationMessage;
import com.example.chat.domain.User;
import com.example.chat.repository.ConversationAttachmentRepository;
...
public class ConversationAttachmentService {
    ...
    public ConversationAttachmentService(ConversationAttachmentRepository repo,
                                         ...
                                         @Value("${chat.attachments.dir:./data/attachments}") String storageDir) {
        this.repo = repo;
     ...
     * cap from {@link com.example.chat.security.CurrentUser#uploadCapBytes}; pass
    ...
    public ConversationAttachment upload(Conversation conversation, User uploader,
        ...
        if (maxBytes >= 0 && declaredSize > maxBytes) {
            throw new com.example.chat.security.UploadTooLargeException(maxBytes);
        }
