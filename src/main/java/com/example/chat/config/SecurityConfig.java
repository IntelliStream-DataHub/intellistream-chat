...
import com.example.chat.security.KeycloakRolesConverter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(@Value("${chat.security.cookie-secure:false}") boolean cookieSecure) {
    ...
    // server.servlet.session.cookie.secure → ${chat.security.cookie-secure:false}.
