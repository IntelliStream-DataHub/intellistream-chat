...
import com.example.chat.security.RateLimitExceededException;
import com.example.chat.security.RateLimiter;
import com.example.chat.service.ConversationAttachmentService;
import com.example.chat.service.ConversationReactionService;
import com.example.chat.service.ConversationService;
import com.example.chat.service.MarkdownRenderer;
import com.example.chat.service.UserService;
import com.example.chat.web.dto.AddGroupMemberRequest;
import com.example.chat.web.dto.ConversationDto;
import com.example.chat.web.dto.ConversationEvent;
import com.example.chat.web.dto.ConversationMemberDto;
import com.example.chat.web.dto.ConversationMessageDto;
import com.example.chat.web.dto.CreateGroupRequest;
...
public class ConversationRestController {
    ...
    public ConversationDto createGroup(@Valid @RequestBody CreateGroupRequest request,
        ...
        if (memberNames.isEmpty()) {
            throw new com.example.chat.security.PublicBadRequestException(
    ...
    private ConversationMessageDto broadcastUpdate(com.example.chat.domain.ConversationMessage message, User viewer) {
    ...
    public ConversationMessageDto sendMessage(@PathVariable UUID id,
                                              @Valid @RequestBody com.example.chat.web.dto.SendMessageRequest body,
                                              Principal principal) {
        var me = currentUser.resolve(principal);
    ...
    public ConversationMessageDto uploadAttachment(@PathVariable UUID conversationId,
        ...
        String caption = "";
        com.example.chat.domain.ConversationAttachment savedAttachment = null;
    ...
    public ResponseEntity<Resource> downloadAttachment(@PathVariable UUID conversationId,
        ...
        com.example.chat.domain.ConversationAttachment attachment;
        try {
     ...
     */
    private User otherParticipant(com.example.chat.domain.Conversation conv, User me) {
