...
import com.example.chat.web.dto.PollDto;
...
public class PollRestController {
    ...
    public PollDto castVote(@PathVariable UUID pollId,
        ...
        if (!rateLimiter.tryAcquire(me.getUsername(), "poll-vote", 30, java.time.Duration.ofMinutes(1))) {
            throw new com.example.chat.security.RateLimitExceededException("vote rate exceeded");
        }
     ...
     */
    private UUID requireMembership(UUID pollId, com.example.chat.domain.User me) {
