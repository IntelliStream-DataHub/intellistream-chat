...
import com.example.chat.web.dto.ChannelDto;
import com.example.chat.web.dto.ChannelMemberDto;
import com.example.chat.web.dto.CreateChannelRequest;
import com.example.chat.web.dto.InviteRequest;
...
public class ChannelRestController {
    ...
    public List<MessageDto> messages(@PathVariable UUID id,
        ...
        List<com.example.chat.domain.Message> rows;
        if (before != null) {
