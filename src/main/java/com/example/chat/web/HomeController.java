...
public class HomeController {
    ...
    private final com.example.chat.service.ConversationAttachmentService conversationAttachmentService;
    private final com.example.chat.service.PollService pollService;
    ...
    public HomeController(SidebarService sidebarService,
                          ...
                          com.example.chat.service.ConversationAttachmentService conversationAttachmentService,
                          com.example.chat.service.PollService pollService,
     ...
     */
    private java.util.List<com.example.chat.domain.Message> safeAround(
            com.example.chat.domain.Channel channel,
            com.example.chat.domain.User me,
            UUID anchorId) {
        try {
    ...
    private List<ConversationDto> listDirectConversations(com.example.chat.domain.User me) {
        var convs = conversationService.listForUser(me);
        var ids = convs.stream().map(com.example.chat.domain.Conversation::getId).toList();
