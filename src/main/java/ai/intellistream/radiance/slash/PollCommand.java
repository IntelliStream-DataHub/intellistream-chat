...
package ai.intellistream.radiance.slash;
 ...
 *
 * <p>Posts a short host message containing the question, then attaches a {@link ai.intellistream.radiance.domain.Poll}
 * row with the options. The frontend renders the host message with a click-to-vote widget
 * sourced from {@link ai.intellistream.radiance.web.dto.PollDto} on the message DTO. Reactions on the
