...
import ai.intellistream.radiance.service.SidebarService;
...
public class HomeController {
    ...
    private final ai.intellistream.radiance.service.ConversationAttachmentService conversationAttachmentService;
    private final ai.intellistream.radiance.service.PollService pollService;
    ...
    public HomeController(SidebarService sidebarService,
                          ...
                          ai.intellistream.radiance.service.ConversationAttachmentService conversationAttachmentService,
                          ai.intellistream.radiance.service.PollService pollService,
    ...
    private List<ConversationDto> listDirectConversations(ai.intellistream.radiance.domain.User me) {
        var convs = conversationService.listForUser(me);
        var ids = convs.stream().map(ai.intellistream.radiance.domain.Conversation::getId).toList();
