...
import ai.intellistream.radiance.service.ConversationAttachmentService;
import ai.intellistream.radiance.service.ConversationReactionService;
...
import ai.intellistream.radiance.web.dto.AddGroupMemberRequest;
import ai.intellistream.radiance.web.dto.ConversationDto;
import ai.intellistream.radiance.web.dto.ConversationEvent;
import ai.intellistream.radiance.web.dto.ConversationMemberDto;
import ai.intellistream.radiance.web.dto.ConversationMessageDto;
import ai.intellistream.radiance.web.dto.CreateGroupRequest;
import ai.intellistream.radiance.web.dto.EditMessageRequest;
import ai.intellistream.radiance.web.dto.ReactionRequest;
import ai.intellistream.radiance.web.dto.StartDirectRequest;
...
public class ConversationRestController {
    ...
    public ConversationDto createGroup(@Valid @RequestBody CreateGroupRequest request,
        ...
        if (memberNames.isEmpty()) {
            throw new ai.intellistream.radiance.security.PublicBadRequestException(
    ...
    private ConversationMessageDto broadcastUpdate(ai.intellistream.radiance.domain.ConversationMessage message, User viewer) {
    ...
    public ConversationMessageDto uploadAttachment(@PathVariable Long conversationId,
        ...
        String caption = "";
        ai.intellistream.radiance.domain.ConversationAttachment savedAttachment = null;
    ...
    public ResponseEntity<Resource> downloadAttachment(@PathVariable Long conversationId,
        ...
        ai.intellistream.radiance.domain.ConversationAttachment attachment;
        try {
     ...
     */
    private User otherParticipant(ai.intellistream.radiance.domain.Conversation conv, User me) {
