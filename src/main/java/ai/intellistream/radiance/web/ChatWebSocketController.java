...
import ai.intellistream.radiance.web.dto.TypingEvent;
...
public class ChatWebSocketController {
    ...
    public void send(@DestinationVariable Long channelId,
        ...
        ai.intellistream.radiance.slash.SlashCommandResult slashed;
        try {
        ...
        ai.intellistream.radiance.domain.Message saved;
        if (slashed.handled()) {
