 ...
 *       after a deploy.</li>
 *   <li><b>Development</b> ({@code threadorbit.assets.unbundled=true}): the original source files in
...
public class AssetService {
    ...
    public AssetService(@Value("${threadorbit.assets.unbundled:false}") boolean unbundled) {
