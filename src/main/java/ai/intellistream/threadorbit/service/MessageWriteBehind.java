...
public class MessageWriteBehind {
    ...
    public MessageWriteBehind(DataSource dataSource,
                              ...
                              @Value("${threadorbit.write-behind.enabled:true}") boolean enabled,
                              @Value("${threadorbit.write-behind.batch-size:256}") int batchSize,
                              @Value("${threadorbit.write-behind.flush-interval-ms:5}") long flushIntervalMillis,
                              @Value("${threadorbit.write-behind.queue-capacity:100000}") int queueCapacity,
                              @Value("${threadorbit.write-behind.id-block-size:4096}") int idBlockSize,
                              @Value("${threadorbit.write-behind.broadcast-threads:8}") int broadcastThreads,
                              @Value("${threadorbit.write-behind.flush-threads:4}") int flushThreads) {
