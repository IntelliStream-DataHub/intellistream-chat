...
import ai.intellistream.threadorbit.service.SidebarService;
...
public class HomeController {
    ...
    private final ai.intellistream.threadorbit.service.ConversationAttachmentService conversationAttachmentService;
    private final ai.intellistream.threadorbit.service.PollService pollService;
    ...
    public HomeController(SidebarService sidebarService,
                          ...
                          ai.intellistream.threadorbit.service.ConversationAttachmentService conversationAttachmentService,
                          ai.intellistream.threadorbit.service.PollService pollService,
     ...
     */
    private java.util.List<ai.intellistream.threadorbit.domain.Message> safeAround(
            ai.intellistream.threadorbit.domain.Channel channel,
            ai.intellistream.threadorbit.domain.User me,
            Long anchorId) {
        try {
    ...
    private List<ConversationDto> listDirectConversations(ai.intellistream.threadorbit.domain.User me) {
        var convs = conversationService.listForUser(me);
        var ids = convs.stream().map(ai.intellistream.threadorbit.domain.Conversation::getId).toList();
