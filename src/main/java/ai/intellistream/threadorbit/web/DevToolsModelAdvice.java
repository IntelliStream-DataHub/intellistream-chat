 ...
 * the test runner. The {@code dev} profile sets {@code threadorbit.dev-tools.enabled=true}
...
public class DevToolsModelAdvice {
    ...
    public DevToolsModelAdvice(@Value("${threadorbit.dev-tools.enabled:false}") boolean enabled) {
